...
if __name__ == "__main__":
    ...
    save_dict_to_json(a1_stats, "a1_stats")
    save_dict_to_json(a2_stats, "a2_stats")
    save_dict_to_json(a3_stats, "a3_stats")
    save_dict_to_json(a4_stats, "a4_stats")
    save_dict_to_json(a5_stats, "a5_stats")
